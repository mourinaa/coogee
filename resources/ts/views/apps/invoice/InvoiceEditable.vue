...
<template>
  <VCard>
    ...
    <VCardText class="d-flex flex-wrap justify-space-between flex-column flex-sm-row">
      ...
      <div class="mt-4 ma-sm-4">
        ...
        <h6 class="d-flex align-center font-weight-medium justify-sm-end text-xl mb-3">
          ...
          <span>
            <VTextField v-model="props.data.invoice.id" disabled prefix="#" density="compact" style="width: 8.9rem" />
          </span>
        </h6>
    ...
    <VCardText class="d-flex flex-wrap justify-space-between flex-column flex-sm-row gap-4">
      <div class="ma-sm-4" style="width: 15.5rem">
    ...
    <VCardText class="add-products-form">
      <div v-for="(product, index) in props.data.purchasedProducts" :key="product.title" class="ma-sm-4">
    ...
    <VCardText class="d-flex justify-space-between flex-wrap flex-column flex-sm-row">
      <div class="mx-sm-4 my-2">
        <div class="d-flex align-center mb-4">
          <h6 class="text-sm font-weight-semibold me-2">Salesperson:</h6>
          <VTextField v-model="props.data.salesperson" style="width: 10rem" />
        </div>

        <VTextField v-model="props.data.thanksNote" placeholder="Thanks for your business" />
      </div>
