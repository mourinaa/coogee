...
invoiceListStore
  ...
  .then((response) => {
    ...
    */
    ...
    console.log('INVOICE DETAIL FETCHED', response.data);
  })
  .catch((error) => {
    console.log(error);
  });
    ...
    <VCol cols="12" md="3">
      <VCard class="mb-8">
        <VCardText>
          ...
          <VBtn block prepend-icon="tabler-send" class="mb-2" @click="isSendSidebarActive = true"> Send Invoice </VBtn>
          ...
          <div class="d-flex gap-2">
            ...
            <div class="w-50">
              <!-- 👉 Save button -->
              <VBtn block color="secondary" variant="tonal" class="mb-2"> Save </VBtn>
            </div>
          </div>
