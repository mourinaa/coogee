...
watch(props, () => {
  ...
  console.log('WATCH PROPS', props.userData);
});
      ...
      <VCardText>
        ...
        <VForm class="mt-6" @submit.prevent="onFormSubmit">
          <VRow>
            <!-- 👉 First Name -->
            <VCol cols="12" md="6">
              <VTextField v-model="userData.fullName.split(' ')[0]" label="first Name" />
            </VCol>

            <!-- 👉 Last Name -->
            <VCol cols="12" md="6">
              <VTextField v-model="userData.fullName.split(' ')[1]" label="Last Name" />
            </VCol>
